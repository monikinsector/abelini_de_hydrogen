...
export type MetaobjectByIdQueryVariables = StorefrontAPI.Exact<{
...
export type CheckArticleQueryVariables = StorefrontAPI.Exact<{
  blogHandle: StorefrontAPI.Scalars['String']['input'];
  articleHandle: StorefrontAPI.Scalars['String']['input'];
}>;

export type CheckArticleQuery = {
  blog?: StorefrontAPI.Maybe<{
    articleByHandle?: StorefrontAPI.Maybe<
...
export type ArticleDataQueryVariables = StorefrontAPI.Exact<{
  blogHandle: StorefrontAPI.Scalars['String']['input'];
  articleHandle: StorefrontAPI.Scalars['String']['input'];
}>;

export type ArticleDataQuery = {
  blog?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Blog, 'title' | 'handle'> & {
      articleByHandle?: StorefrontAPI.Maybe<
        Pick<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n          query CheckArticle($blogHandle: String!, $articleHandle: String!) {\n            blog(handle: $blogHandle) {\n              articleByHandle(handle: $articleHandle) {\n                handle\n              }\n            }\n          }\n        ': {
    return: CheckArticleQuery;
    variables: CheckArticleQueryVariables;
  };
  '#graphql\n      query ArticleData($blogHandle: String!, $articleHandle: String!) {\n        blog(handle: $blogHandle) {\n          title\n          handle\n          articleByHandle(handle: $articleHandle) {\n            handle\n            title\n            contentHtml\n            publishedAt\n            author: authorV2 {\n              name\n            }\n            image {\n              id\n              altText\n              url\n              width\n              height\n            }\n            seo {\n              description\n              title\n            }\n          }\n        }\n      }\n    ': {
    return: ArticleDataQuery;
    variables: ArticleDataQueryVariables;
  };
